...
// If the price variable is greater than 5 and less than or equal to 10, log the message "Take off 10% and you've got a deal."
// If the price variable is greater than 10, log the message "_____ for this? You must be joking!"
// Fill in the blanks with the value of the price variable, i.e. "500 for this? You must be joking!"
